  ...
  return (
    <main className="relative w-full h-[100dvh] overflow-hidden bg-black md:bg-background">
      ...
      <header className="fixed top-0 inset-x-0 z-50 pointer-events-none">
        <div className="pointer-events-auto bg-gradient-to-b from-black/90 via-black/55 to-transparent pt-3 pb-6 px-4">
          {/* Single clean row: LEFT = WHATDO logo + For You/Latest toggle; RIGHT = Search + Profile/Login */}
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2 min-w-0">
              <Link href="/" className="flex items-center gap-1.5 shrink-0">
                ...
                <span className="font-black text-[1.05rem] leading-none tracking-tight text-white drop-shadow-lg">
                  WHATDO
                </span>
              </Link>

              {/* Feed sort (For You / Latest) RIGHT AFTER the brand logo on the same TOP row — user requested it here */}
              <div className="min-w-0 flex items-center pl-0.5">
                <div className="inline-flex items-center rounded-full bg-white/12 backdrop-blur-md border border-white/18 p-0.5 shadow-lg shadow-black/20">
                  <button
                    ...
                    className={cn(
                      "inline-flex items-center gap-1 h-[1.55rem] px-2.5 rounded-full text-[10.5px] font-bold transition-all whitespace-nowrap",
                      sortMode === "foryou"
